...
enum="INVALID_REQUEST BAD_REQUEST VALIDATION_ERROR MISSING_REQUIRED_FIELD UNSUPPORTED_OPERATION UNSUPPORTED_PROVIDER \
INVALID_TOKEN EXPIRED_TOKEN LOGIN_REQUIRED REFRESH_TOKEN_NOT_FOUND FORBIDDEN USER_NOT_FOUND POST_NOT_FOUND \
REPORT_NOT_FOUND CHAT_NOT_A_MEMBER CHAT_ROOM_NOT_FOUND PROPOSAL_NOT_FOUND SUBSCRIPTION_NOT_FOUND DUPLICATE_RESOURCE CLOSED PAYMENT_FAILED \
UPLOAD_CONTENT_TYPE_NOT_ALLOWED UPLOAD_FILE_EMPTY UPLOAD_FILE_TOO_LARGE INTERNAL_SERVER_ERROR \
