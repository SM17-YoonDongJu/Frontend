...
enum="INVALID_REQUEST VALIDATION_ERROR MISSING_REQUIRED_FIELD UNSUPPORTED_OPERATION UNSUPPORTED_PROVIDER \
INVALID_TOKEN EXPIRED_TOKEN LOGIN_REQUIRED REFRESH_TOKEN_NOT_FOUND FORBIDDEN USER_NOT_FOUND POST_NOT_FOUND \
SUBSCRIPTION_NOT_FOUND DUPLICATE_RESOURCE CLOSED PAYMENT_FAILED INTERNAL_SERVER_ERROR \
