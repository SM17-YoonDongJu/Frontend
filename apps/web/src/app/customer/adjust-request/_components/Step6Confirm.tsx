...
export function Step6Confirm() {
  ...
  return (
    <section className="flex flex-col gap-5">
      <div>
        <h2 className="font-serif text-[22px] font-bold text-ink">분석 준비가 끝났어요</h2>
      ...
      <div className="flex flex-col gap-3">
        <div>
          ...
          {errors.agreedToPrivacy && (
            <p className="mt-1 text-[12px] font-medium text-terra">
        ...
        <div>
          ...
          {errors.agreedToTerms && (
            <p className="mt-1 text-[12px] font-medium text-terra">{errors.agreedToTerms.message}</p>
          )}
        </div>
      </div>
    </section>
