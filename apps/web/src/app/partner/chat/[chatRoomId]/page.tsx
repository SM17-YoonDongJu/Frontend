...
const REPORT_BASE_PATH = "/partner/review";

export default async function PartnerChatThreadPage({
  params,
}: {
  ...
  return (
    <ChatSplitShell
      ...
      list={
        ...
        >
          <ChatListContent chatBasePath={CHAT_BASE_PATH} activeChatRoomId={chatRoomId} />
        </ChatSectionBoundary>
      }
      main={
        <ChatSectionBoundary
